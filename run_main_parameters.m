...
alphas = [1e-8, 1e-7, 1e-6, 5e-6, 1e-5, 5e-4, 1e-4, 5e-3, 1e-3, 5e-3, 1e-2, 5e-2, 0.1];
betas = [1e-4, 1e-3, 5e-3, 1e-2, 5e-2, 0.1, 0.5, 1, 2, 5, 10, 20, 50, 100];
...
% We may set the varaiable "repeated_times" to 10 for the best result
